...
cursor --install-extension cursor-remote-0.1.53.vsix
```
...
Don't have a key? Get one from the [store](https://wa.me/5599988284904).
...
On first run, you'll be prompted for a **license key**. Get one from the [store](https://wa.me/5599988284904). The key is saved to `data/license.key`.
